...
const OneTimePurchaseButton = ({ priceId }: { priceId: string }) => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
      {config.stripe.additionalPlans.map((plan) => (
        <Card
          key={plan.name}
          className="flex flex-col border-neutral-800 bg-background/50 transition-colors hover:border-primary/50"
        >
          <CardHeader>
