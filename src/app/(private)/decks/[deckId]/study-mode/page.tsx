    ...
    <div className="flex flex-col justify-center min-h-screen gap-8 max-w-lg mx-auto p-4 sm:p-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <Link href={`/decks/${deckId}/study-mode/multiple-choice`}>
          <Card className="h-full p-6 bg-slate-800 shadow-lg rounded-lg transition-shadow duration-200 ease-in-out hover:shadow-xl hover:bg-slate-700">
            <div className="flex flex-col h-full">
              ...
              <p className="flex-1 text-lg text-slate-400">Teste seu conhecimento escolhendo a resposta correta entre várias opções. Ideal para revisar conceitos e fixar o aprendizado.</p>
            </div>
          </Card>
        </Link>
        <Link href={`/decks/${deckId}/study-mode/flashcard`}>
          <Card className="h-full p-6 bg-slate-800 shadow-lg rounded-lg transition-shadow duration-200 ease-in-out hover:shadow-xl hover:bg-slate-700">
            <div className="flex flex-col h-full">
              ...
              <p className="flex-1 text-lg text-slate-400">Revise os cartões um por um, tentando lembrar a resposta antes de revelá-la. Ótimo para memorização e revisão espaçada.</p>
            </div>
          </Card>
        </Link>
      </div>
